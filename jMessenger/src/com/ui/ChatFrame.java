...
public class ChatFrame extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try 
        { 
    	String originalString = jTextField4.getText();
    	System.out.println("Calculating the sha hash of the input message");
    	final String secretKey = toHexString(getSHA(originalString));
    	System.out.println("Hash generated of the string: "+secretKey);
		...
		if(!msg.isEmpty() && !target.isEmpty()){
            jTextField4.setText("");
            System.out.println("Embedding the payload onto the image");
            client.send(new Message("message", username, encryptedString, target));
        }
        }
    	catch (NoSuchAlgorithmException e) {  
